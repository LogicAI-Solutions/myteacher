...
import {
    ...
    MessageCircle, Shield, LogIn, Check, X, CalendarDays, Video,
...
export const Landing = () => {
    ...
    return (
        <div className="min-h-screen bg-bg-dark text-text-main font-sans">
            <a href="#conteudo" className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[60] btn btn-primary">Pular para o conteúdo</a>
            <nav aria-label="Navegação principal" className="fixed top-0 w-full z-50 sheet-header px-4 py-3 sm:px-6">
                <div className="container mx-auto flex justify-between items-center max-w-6xl">
                    ...
                    <div className="hidden lg:flex items-center gap-6 text-sm text-text-muted"><a href="#como-funciona" className="hover:text-primary transition-colors">Como funciona</a><a href="#exemplos" className="hover:text-primary transition-colors">Exemplos</a><a href="#recursos" className="hover:text-primary transition-colors">Recursos</a><a href="#planos" className="hover:text-primary transition-colors">Planos</a></div>
                    <div className="flex items-center gap-2 sm:gap-3"><Link to="/login" className="btn btn-ghost" title="Acessar o sistema"><LogIn size={16} /><span>Entrar</span></Link><Link to="/register" className="btn btn-primary"><span>Começar grátis</span></Link></div>
                </div>
            </nav>
                ...
                <header className="pt-28 pb-16 lg:pt-36 lg:pb-24 px-4 sm:px-6 relative overflow-hidden">
                    ...
                    <div className="container mx-auto grid lg:grid-cols-[0.92fr_1.08fr] gap-10 lg:gap-16 items-center max-w-6xl relative">
                        <div className="animate-slide-up">
                            <p className="label-print mb-4">Sistema de gestão para professores particulares</p>
                            ...
                            <div className="mt-7 flex flex-col sm:flex-row gap-3"><Link to="/register" className="btn btn-primary text-base px-5 py-2.5 group">Criar minha conta grátis<ArrowRight className="group-hover:translate-x-0.5 transition-transform w-4 h-4" /></Link><a href="#exemplos" className="btn btn-outline text-base px-5 py-2.5">Ver exemplos</a></div>
